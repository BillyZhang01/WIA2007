    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAgriIQ.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, AgriIQActivity.class);
        ...
        btnAriAid.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(MainActivity.this, AgriAidActivity.class);
                startActivity(intent);
            }
        });
        btnAgrilab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(MainActivity.this, AgriLabActivity.class);
                startActivity(intent);
            }
        });
        //在这里是题库的加载逻辑
